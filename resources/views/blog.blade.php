    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <ul>
                    <li>
                        <p><a href="{{ url('/blog-details') }}">Dolorum corporis ullam, reiciendis inventore est
                                repudiandae</a>
                        </p>
                    ...
                    <li>
                        <p><a href="{{ url('/blog-details') }}">Culpa ab quasi in rerum dolorum impedit expedita</a></p>
                        <small><i class="fa fa-user"></i> John Doe &nbsp;|&nbsp; <i class="fa fa-calendar"></i>
                            27.07.2020 10:10</small>
                    </li>
                    ...
                    <li>
                        <p><a href="{{ url('/blog-details') }}">Explicabo soluta corrupti dolor doloribus optio
                                dolorum</a></p>
